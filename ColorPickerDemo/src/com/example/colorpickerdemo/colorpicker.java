...
/***
 * 原作者：clarkamx@gmail.com 来源：http://www.oschina.net/
 */
...
public class colorpicker extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_color_picker_demo_main);
    	...
    	LinearLayout ll = (LinearLayout)findViewById(R.id.colorpicker_layout);
		ll.addView(myView);
